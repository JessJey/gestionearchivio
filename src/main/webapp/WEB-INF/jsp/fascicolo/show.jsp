		...
		<div class="container">
			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<dl class="row">
						<dt class="col-sm-3 text-right">Data Apertura:</dt>
						<dd class="col-sm-9">
							<fmt:formatDate type="date"
								value="${show_fascicolo_attr.dataCreazione}" />
						</dd>
					</dl>
					...
					<dl class="row">
						...
						<dd class="col-sm-9">
							<fmt:formatDate type="date"
								value="${show_fascicolo_attr.dataChiusura}" />
						</dd>
					</dl>
				...
				<div class='card-footer'>
					<a href="${pageContext.request.contextPath}/fascicolo"
